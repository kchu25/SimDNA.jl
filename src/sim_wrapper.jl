...
mutable struct Sim_DNA{T <: Integer, S <: Real} 
    ...
    function Sim_DNA{T, S}(motif::motif_type, 
        ...
        data_matrix, data_matrix_bg, data_matrix_test, data_matrix_bg_test, N_train, N_test = 
        ...
        data_matrix_test = reshape(data_matrix_bg, (L,1, N_test));
        new(
            raw_data,
            motif,
            T(N_train),
    ...
    function Sim_DNA{T,S}(motif::motif_type; 
        ...
        data_matrix_test = reshape(data_matrix_bg, (L,1, N_test));
        new(
            raw_data, motif, T(N_train), T(L/4),
            data_matrix, 
            cu(data_matrix), 
            data_matrix_bg, 
            nothing, 
